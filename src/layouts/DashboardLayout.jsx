...
export default function DashboardLayout() {
  ...
  // 2. Ops Items (✅ Added Inventory back here)
  const opsItems = [
  ...
  // 3. Procurement Items (New section for LPO & Vendors)
  const procurementItems = [
    { name: 'LPO Generator', path: '/operations/lpo-generator', icon: (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>)},
    { name: 'Vendors', path: '/procurement/vendors', icon: (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>)}
  ];
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto relative scroll-smooth">
        <header className="h-20 shrink-0 bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 flex items-center justify-between px-6 lg:px-10">
          ...
          <div className="flex items-center gap-3.5">
            {/* Minimal Fintech Live Dubai Date & Time Pill */}
            {dubaiTime && (
              <div className="hidden sm:flex items-center gap-3 px-3.5 py-1.5 bg-slate-50 border border-slate-200/80 rounded-2xl">
